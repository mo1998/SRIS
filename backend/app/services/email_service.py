...
Supports providers:
  - mailpit: Mailpit HTTP API (default, for development)
  - brevo:  Brevo transactional email API (for production)
"""
...
def get_email_health() -> Dict[str, object]:
    ...
    if provider == "brevo":
        ...
        missing_settings.append("MAIL_PROVIDER")
...
def _send_email(
    ...
    if provider == "brevo":
        ...
        _send_via_mailpit(to_email, to_name, subject, html_content)
    else:
